...
node --test dist/test/hotswap-gc.test.js dist/test/hotswap-identity.test.js dist/test/hotswap-sse.test.js dist/test/hotswap.test.js dist/test/hotswap-adoption.test.js 2>&1 | tee .hotswap-results/compiled-acceptance.log
